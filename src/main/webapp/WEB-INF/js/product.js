...
//    var e = 502, i = 358, s = '        <div id="Fqfk_Tip" class="Tip360" style="width:auto;">            <div class="Tip_Title">                <em>                    <img src="' + fq_serverSite + 'skin/WEB-INF/images/tip_close.jpg" class="Tip_Close"/>                </em>\u767d\u6761/\u5206\u671f            </div>            <div class="Tip_Content" id="Tip_fq0">                <div id="baitiaofenqi" style="position:relative;width:482px;height:330px;">                </div>            </div>        </div>', a = ("<div id='c04tip' class='clearfix' style='z-index:20000;position:absolute;width:" + (e + 5) + "px;height:" + (i + 5) + "px;'><div style='position:absolute;margin:5px 0 0 5px;width:" + e + "px;height:" + i + "px;z-index:20001;'>{HTML}</div></div>").replace("{HTML}", s), n = $(a);
...
//        G.isPop ? $.ajax({url: "http://misc.360buyimg.com/product/WEB-INF/js/2012/suits.js",dataType: "script",scriptCharset: "gb2312",cache: !0,success: function() {
...
//    G.isJd && "enabled" == pageConfig.btnBaiTiaoFq && t.after(e)
    ...
    if ($('#product-detail [data-widget="tab-item"]').find("a").addClass("toggle-link"), function() {
        ...
        return 1 > a.length ? !1 : (p.find("a").addClass("toggle-link"), o = function() {
            ...
            $.ajax({url: "http://misc.360buyimg.com/product/WEB-INF/js/2012/footprint.js?ver=20140724",dataType: "script",cache: !0})
    ...
    }), $("#comments-list .tab").append('<li class="tab-last"></li>'), renew(), /from=email/.test(location.href) && $.ajax({url: "http://misc.360buyimg.com/product/WEB-INF/js/2012/notify.js",dataType: "script",cache: !0,success: function() {
...
//                }
    ...
    if (setImButton(G.sku), 1319 === G.cat[0] && $.ajax({url: "http://misc.360buyimg.com/product/WEB-INF/js/2012/item.baby.js?ver=20140123",cache: !0,dataType: "script",scriptCharset: "gb2312"}), jdSref && searchEngineSource) {
        var m = "&encode=utf-8";
...
//            "true" !== t.mBuy.attr("loaded") && ($.ajax({url: "http://misc.360buyimg.com/product/WEB-INF/js/2012/qrcode.js?ver=20140527",dataType: "script",scriptCharset: "gb2312",cache: !0}), t.mBuy.attr("loaded", "true"))
//        }), void 0)
    },setProm: function(t) {
