...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link href="/WEB-INF/css/purchase.2012.css?v=201410141639" rel="stylesheet" type="text/css">
...
<div class="w w1 header clearfix">
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/WEB-INF/images/taotao-logo.gif" title="返回淘淘商城首页" alt="返回淘淘商城首页"></a></div>
...
<script type="text/javascript" src="/WEB-INF/js/base-v1.js"></script>
<!-- footer start -->
<jsp:include page="commons/footer.jsp" />
<!-- footer end -->

<!-- 购物车相关业务 -->
<script type="text/javascript" src="/WEB-INF/js/cart.js"></script>
<script type="text/javascript" src="/WEB-INF/js/jquery.price_format.2.0.min.js"></script>
