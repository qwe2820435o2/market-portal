...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
   ...
   <link type="text/css" rel="stylesheet" href="/WEB-INF/css/base.css" />
   <link rel="stylesheet" type="text/css" href="/WEB-INF/css/purchase.base.2012.css" />
   <link rel="stylesheet" type="text/css" href="/WEB-INF/css/purchase.sop.css" />
   ...
   <script type="text/javascript" src="/WEB-INF/js/jquery.cookie.js" charset="utf-8"></script>
   <script type="text/javascript" src="/WEB-INF/js/taotao.js" charset="utf-8"></script>
</head> <body id="mainframe">
<!--shortcut start-->
<jsp:include page="commons/shortcut.jsp" />
<!--shortcut end-->
<div class="w" id="headers">
		<div id="logo"><a href="http://www.jd.com/"><img alt="淘淘商城" src="/WEB-INF/images/taotao-logo.gif"></a></div>
